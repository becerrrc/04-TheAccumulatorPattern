...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 8
    answer = count_cosines_from(4, 23, .23)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 10
    answer = count_cosines_from(0, 15, -0.37)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(3, 7, -0.5)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 7
    answer = count_cosines_from(2, 19, 0.14)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.484897  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(4, 15)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.828968  # This is APPROXIMATELY the correct answer.
